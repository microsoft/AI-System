...
<center>图1-5-5. SISD对比SIMD (<a href="">图片引用</a>)</center>
...
<center>图1-5-6. 此示例并行执行只需要串行执行的1/3时间即可完成 </center>
...
<center>图1-5-7. 阿姆达尔定律 (<a href="https://en.wikipedia.org/wiki/Amdahl%27s_law">图片引用</a>)</center>
...
<center>图1-5-8. 副本机制 (<a href="">图片引用</a>)</center>
