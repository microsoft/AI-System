...
图1-4-1. 内存层级(Memory Hierarchy)[图片引用](https://diveintosystems.org/book/C11-MemHierarchy/mem_hierarchy.html)
在图中我们看到传统的内存层级问题总结中没有覆盖GPU和AI加速器，我们可以通过PCIe总线将AI加速器与当前已有体系结构互联，让计算机利用AI加速器加速模型的训练与推理。
...
图1-4-2. NVIDIA GPU架构与内存层级[图片引用](https://docs.nvidia.com/deeplearning/performance/dl-performance-gpu-background/index.html)
