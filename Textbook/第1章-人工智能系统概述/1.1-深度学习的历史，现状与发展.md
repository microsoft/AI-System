...
2011 年 8 月，来自微软研究院的 Frank Seide, Gang Li, Dong Yu 当时使用的深度神经网络模型在语音转录（Speech Transcription）取得突破进展，其发表在 Interspeech 2011 上的 “[Conversational Speech Transcription Using Context-Dependent Deep Neural Networks](https://dl.acm.org/doi/10.5555/3042573.3042574)”介绍了其中的设计和结果。在单通道非特定人识别（Single-pass Speaker-independent Recognition）基准测试上将相对错误率由 27.4% 降低到 18.5% 相对降低 33%，在其他 4 类任务中相对降低 22–28%。其背后通过几百台的 CPU 集群训练出来。在人工智能的历史上，我们更多的会关注算法与模型的进步，却忽视了人工智能系统这类基础设施的支持才让灵感得以落地和产出。
