...
2011 年，微软首席研究官 Rick Rashid 博士在天津举办的 “[21 世纪的计算-自然而然](https://www.youtube.com/watch?v=5c1gKTOQfuo)” 会议上展示了他们实时语音机器翻译最新进展，相比之前的方法，新语音识别方法取得了突破性进展，错误率下降了 30%，7、8 个单词中仅有 1 例错误。Rashid 提到，“大约在两年前，微软研究院和多伦多大学的研究员取得了重要突破。通过深度神经网络（Deep Neural Networks）的技术来实现个体差别、更好的语音识别。” 当时使用的深度设计网络模型是发表在 INTERSPEECH 2011 上的 “[Conversational Speech Transcription Using Context-Dependent Deep Neural Networks](https://dl.acm.org/doi/10.5555/3042573.3042574)”，其背后通过几百台的 CPU 集群训练出来。在人工智能的历史上，我们更多的会关注算法与模型的进步，却忽视了人工智能系统这类基础设施的支持才让灵感得以落地和产出。
