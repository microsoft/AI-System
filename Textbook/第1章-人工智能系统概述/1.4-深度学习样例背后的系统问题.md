...
“Inside every large program is a small program struggling to get out.”--Tony Hoare。我们从下面实例会看到，目前算法工程师只需要书写核心算法（small program - 核心算法与高层设计），而不需要关注底层的很多代码（底层 large program）细节，通过层层抽象，提升了开发效率，但是对系统研发却隐藏了细节，需要我们进一步探究。
