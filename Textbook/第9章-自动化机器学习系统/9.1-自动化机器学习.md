...
神经网络结构搜索算法和超参数优化算法有很多相似之处，又存在很大的不同。相同之处在于，如果把神经网络结构空间使用超参数来描述的话，超参数优化算法都可以作为神经网络结构搜索算法使用。而不同之处在于神经网络结构搜索有其自己的特点，基于这些特点而设计的搜索算法和超参数搜索算法就有很大的不同。

和超参数优化算法十分相似并且可以应用到超参数优化上
