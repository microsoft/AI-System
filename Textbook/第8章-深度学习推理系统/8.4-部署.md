...
- [8.4 部署](#84-部署)
  ...
  - [8.4.5 推理芯片](#845-推理芯片)
  - [8.4.6 配置镜像与容器进行云上训练或，推理与压测实验](#846-配置镜像与容器进行云上训练或推理与压测实验)
    - [8.4.6.1 实验目的](#8461-实验目的)
    - [8.4.6.2 实验环境](#8462-实验环境)
    - [8.4.6.3 实验原理](#8463-实验原理)
    - [8.4.6.4 实验内容](#8464-实验内容)
    - [8.4.6.5 实验报告](#8465-实验报告)
  - [8.4.7 代表性推理系统](#847-代表性推理系统)
  - [小结与讨论](#小结与讨论)
  - [参考文献](#参考文献)
