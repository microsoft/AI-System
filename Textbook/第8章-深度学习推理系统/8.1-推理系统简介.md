...
接下来我们通过 MMdnn[<sup>[2]</sup>](#mmdnn) 中自带的一个模型在 TensorRT 的推理过程实例来了解通过程序中使用推理工具和系统进行的模型推理的常见步骤。
...
<center>图 8.1.4 推理服务系统 (<a href="https://github.com/microsoft/pai">图片来源</a>)</center>
