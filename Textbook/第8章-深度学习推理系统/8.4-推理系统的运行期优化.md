...
加速器的低效率使用常常由于所执行的负载的运算量不够高或者由于等待请求或 IO 等造成资源空置和浪费。如图 8.4.2 所示，如果设备（Device）中只部署了单个模型，由于等待批处理请求，可能造成 GPU 空闲。
...
<center>图 8.4.4 NVIDIA深度学习推理性能测试 <a href="https://developer.nvidia.com/deep-learning-performance-training-inference">图片来源</a> </center>
...
- [Dynamic Batcher](https://github.com/triton-inference-server/server/blob/main/docs/model_configuration.md#dynamic-batcher)
- [model_analyzer](https://github.com/triton-inference-server/server/blob/main/docs/model_analyzer.md)
- [preferred-batch-sizes](https://github.com/triton-inference-server/server/blob/main/docs/model_configuration.md#preferred-batch-sizes)
- [Best-fit bin packing](https://en.wikipedia.org/wiki/Best-fit_bin_packing)
- [concurrent-model-execution](https://github.com/triton-inference-server/server/blob/main/docs/architecture.md#concurrent-model-execution)
- [multiple-model-instances](https://github.com/triton-inference-server/server/blob/main/docs/model_configuration.md#multiple-model-instances)
...
- [TensorFlow: How to measure how much GPU memory each tensor takes?](https://stackoverflow.com/questions/36331419/tensorflow-how-to-measure-how-much-gpu-memory-each-tensor-takes/43189934#43189934)
...
- [A Memory Allocator by Doug Lea](https://www.cs.tufts.edu/~nr/cs257/archive/doug-lea/malloc.html)
- [Buddy memory allocation](https://en.wikipedia.org/wiki/Buddy_memory_allocation)
- [Kernel Memory Allocation](https://slideplayer.com/slide/3544296/)
