...
- [8.3 推理系统的高吞吐与高效率优化](#83-推理系统的高吞吐与高效率优化)
  ...
  - [8.3.2 加速器并行](#832-加速器并行)
  - [8.3.3 动态批尺寸](#833-动态批尺寸)
  - [8.3.4 多模型装箱](#834-多模型装箱)
  - [小结与讨论](#小结与讨论)
  - [参考文献](#参考文献)
...
例如，如下图所示，Nvidia所做的在V100上的推理性能基准测试，从图中可以看到，随着批次(Batch Size)不断增加，模型推理的吞吐量在不断上升。

<center> <img src="./img/3/8-3-1-throughput.png" width="400" height="200" /></center>
<center>图8-3-1. Nvidia深度学习推理性能测试</center>
