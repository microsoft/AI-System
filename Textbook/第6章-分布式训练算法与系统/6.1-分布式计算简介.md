...
<center>图: 使用单处理器的程序处理过程 (<a href="https://hpc.llnl.gov/documentation/tutorials/introduction-parallel-computing-tutorial"/> Introduction to Parallel Computing Tutorial</a>) <https://computing.llnl.gov/tutorials/parallel_comp/></center>
...
<center>图: 并行计算涉及的大规模运算 (<a href="https://hpc.llnl.gov/documentation/tutorials/introduction-parallel-computing-tutorial"/> Introduction to Parallel Computing Tutorial</a>) <https://computing.llnl.gov/tutorials/parallel_comp/></center>
