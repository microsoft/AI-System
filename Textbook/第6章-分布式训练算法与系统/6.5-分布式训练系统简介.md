...
<center>图6-5-1: TensorFlow 定义节点信息和参数服务器方式并行化模型</center>
...
<center>图6-5-4: PyTorch中采用点对点同步通信</center>
...
<center>图6-5-5: PyTorch中采用点对点异步通信</center>
...
<center>图6-5-6: PyTorch中的集体式通信</center>
...
<center>图6-5-7: 指定参与成员的集体式通信 </center>
...
<center>图6-5-8: Horovod 实现数据并行的原理 </center>
...
<center>图6-5-9: 调用 Horovod 需要的代码修改 </center>
