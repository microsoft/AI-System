...
- [7. 异构计算集群调度与资源管理系统](第7章-异构计算集群调度与资源管理系统/7-前言.md)
  ...
  - [7.4 面向深度学习的集群管理系统](第7章-异构计算集群调度与资源管理系统/7.4-面向深度学习的集群管理系统.md)
    ...
    - 7.4.5 代表性异构集群管理系统
  - [7.5 存储](第7章-异构计算集群调度与资源管理系统/7.6-存储.md)
    - 7.5.1 沿用大数据平台存储路线
    - 7.5.2 沿用高性能计算平台存储路线
    - 7.5.3 面向深度学习的存储
...
- [8. 深度学习推理系统](第8章-深度学习推理系统/8-前言.md)
  ...
  - [8.3 部署](第8章-深度学习推理系统/8.4-部署.md)
    ...
    - 8.3.6 推理系统部署与压测实验练习
    - 8.3.7 推理系统简介
  - [8.4 推理系统的运行期优化](第8章-深度学习推理系统/8.3-推理系统的运行期优化.md)
    - 8.4.1 推理系统的吞吐量
    - 8.4.2 加速器模型并发执行
    - 8.4.3 动态批尺寸
    - 8.4.4 多模型装箱
...
- [11. 模型压缩与稀疏化](第11章-模型压缩与稀疏化/11-前言.md)
  ...
  - 11.3 模型压缩与硬件加速
    - 11.3.1 稀疏模型硬件加速
    - 11.3.2 量化模型硬件加速
- [12. 人工智能安全与隐私](第12章-人工智能安全与隐私/12-前沿.md)
  - [12.1 人工智能完整性](第12章-人工智能安全与隐私/12.1-人工智能完整性.md)
    - 12.1.1 推理结果的鲁棒性
    - 12.1.2 推理过程的可信性 
  - [12.2 人工智能保密性](第12章-人工智能安全与隐私/12.2-人工智能保密性.md)
    - 12.2.1 数据保密性 
    - 12.2.2 模型保密性 
...
- [13. 人工智能优化计算机系统](第13章-人工智能优化计算机系统/13-前言.md)
  ...
  - [13.2 学习增强系统的应用](第13章-人工智能优化计算机系统/13.2-学习增强系统的应用.md)
    ...
    - 13.2.1 数据库索引优化
    - 13.2.2 系统选项与参数调优
  - [13.3 落地挑战](第13章-人工智能优化计算机系统/13.3-落地挑战.md)
