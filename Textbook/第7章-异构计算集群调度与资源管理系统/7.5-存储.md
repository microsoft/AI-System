...
<center>图7-5-. Hadoop HDFS架构(<a href="https://hadoop.apache.org/docs/r1.2.1/hdfs_design.html">图片来源</a>)</center>
...
<center>图7-5-. 用户空间文件系统（Filesystem in Userspace）(<a href="https://en.wikipedia.org/wiki/Filesystem_in_Userspace">图片来源</a>)</center>
...
<center>图7-5-. Alluxio可以作为分布式缓存(<a href="https://www.alluxio.io/blog/machine-learning-training-with-alluxio-solution-overview/">图片来源</a>)</center>
...
<center>图7-5-. Alluxio与其他分布式文件系统的混合存储方案 (<a href="https://www.alluxio.io/blog/machine-learning-training-with-alluxio-solution-overview/">图片来源</a>)</center>
...
<center>图7-5-. NFS实例，客户端将NFS挂载到本地/nfs目录(<a href="https://advishnuprasad.com/blog/2016/03/29/setup-nfs-server-and-client-using-ansible/">图片来源</a>)</center>
...
<center>图7-5-. (<a href="https://wiki.lustre.org/Introduction_to_Lustre">图片来源</a>)</center>
